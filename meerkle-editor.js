...
romankle_textarea.addEventListener("change", (event) => {text_string =  romankle_textarea.value; update_textareas})
meerkle_textarea.addEventListener("change", (event) => {text_string =  meerkle_textarea.value; update_textareas})